...
export default {
  ...
  mounted(){
      ...
      let canvasEditAnim = new Theatre({
        ...
        expose: false,
        sharp: true,
        scenarioCtx: require.context('debug/theatre/editAnimations/lifecycles/', true, /^\.\/scenario\.json$/, 'sync'),
        hooksCtx:require.context('debug/theatre/editAnimations/lifecycles/', true, /\.\/(\w+)\/(\w+)\.js$/, 'sync'),
        assetsCtx:{},
