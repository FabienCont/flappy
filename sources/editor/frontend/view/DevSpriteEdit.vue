...
export default {
  ...
  mounted(){
      ...
      this.theatreInstance = new Theatre({
        ...
        expose: false,
        sharp: true,
        scenarioCtx: require.context('editor/frontend/theatre/editAnimations/lifecycles/', true, /^\.\/scenario\.json$/, 'sync'),
        hooksCtx:require.context('editor/frontend/theatre/editAnimations/lifecycles/', true, /\.\/(\w+)\/(\w+)\.js$/, 'sync'),
        assetsCtx:{},
        modelsCtx:require.context('editor/frontend/theatre/editAnimations/models/', true, /^.\/.+\.[a-zA-Z0-9]+$/, 'lazy'),
        scriptsCtx:require.context('editor/frontend/theatre/editAnimations/scripts/', true, /^.\/.+\.[a-zA-Z0-9]+$/, 'lazy'),
        loadingTime:0,
        params:{
          sprite:this.image,
