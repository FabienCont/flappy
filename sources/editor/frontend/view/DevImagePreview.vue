...
export default {
  name: 'DevImagePreview',
  data(){
    return {
      base64:'data:image/png;base64,',
      svgSize:"1.7em",
      elementCopy:this.params.element,
      nameCopy:this.params.name,
      scopeCopy:this.params.scope
    }
  },
  props: {
    params:{
  ...
  computed:{
    ...
    isElementModify:function(){
      return this.params.element!==this.elementCopy || this.scopeCopy!==this.params.scope || this.nameCopy!==this.params.name;
    }
  },
  methods:{
    ...
    copyElement:function(){
      this.elementCopy = this.params.element;
      this.nameCopy=this.params.name;
      this.scopeCopy=this.params.scope;
    },
